...
@export var idle_duration_min := 2
@export var idle_duration_max := 4
...
func update_floor_check_direction():
	var fc = $FloorCheck
	if facing_right:
		fc.target_position = Vector2(12, 30)
	else:
		fc.target_position = Vector2(-12, 30)
...
func attack():
	...
	play_anim("attack" + str(attack_type))
